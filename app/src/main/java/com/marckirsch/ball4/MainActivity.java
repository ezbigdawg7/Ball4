...
//           myIntent.putExtra("test",scoreNewMatchButton.getText());
//        startActivity(myIntent);
        String uniqueID = UUID.randomUUID().toString();
        Toast.makeText(this,uniqueID,Toast.LENGTH_LONG).show();
    }

    public void onRosters(View view) {
       // Intent myIntent = new Intent(MainActivity.this, TestDraw.class);
        final Dialog dialog = new Dialog(this);
        dialog.setContentView(R.layout.addplayer);
        dialog.setTitle("Add Player...");

        // set the custom dialog components - text, image and button

        Button dialogButton = (Button) dialog.findViewById(R.id.buttonSavePlayer);
